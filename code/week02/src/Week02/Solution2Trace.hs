...
import Week02.Solution2UntypedRaw           ( MyRedeemer(..), endpoints )
...
myTrace = do
    ...
    callEndpoint @"grab" h2 (MyRedeemer False True)
    _ <- waitNSlots 5
    ...
    callEndpoint @"grab" h3 (MyRedeemer True True)
    _ <- waitNSlots 5
