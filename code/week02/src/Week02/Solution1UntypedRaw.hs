...
module Week02.Solution1UntypedRaw where
...
mkValidator _ r _
    | r == Builtins.mkConstr 0 [ true,  true] = ()
    | r == Builtins.mkConstr 0 [false, false] = ()
    | otherwise = traceError "wrong redeemer"
  where
    true  = Builtins.mkConstr 0 []
    false = Builtins.mkConstr 1 []
